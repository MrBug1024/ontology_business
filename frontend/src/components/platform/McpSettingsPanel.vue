<template>
  <section class="settings-panel">
    ...
    <el-dialog append-to-body v-if="canManage" v-model="dlg" :title="form.id ? '编辑 MCP' : '新建 MCP'" width="min(720px, 94vw)" @closed="clearFormErrors">
    ...
    <el-dialog append-to-body v-if="canManage" v-model="importDlg" title="导入 mcpServers 配置" width="min(780px, 94vw)" @closed="resetImport">
