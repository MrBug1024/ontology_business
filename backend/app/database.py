...
POSTGRESQL_SCHEMA_REVISION = "20260923_50"
...
def init_db() -> None:
    ...
    from . import access_models, approval_models, distillation_access_models, distillation_attachment_models, distillation_conversation_models, distillation_models, external_api_models, models, release_models  # noqa: F401
